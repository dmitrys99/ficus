...
|*exp1* .*cmpop* *exp2*      |       11  |       левая     |   bool *collection*       |     поэлементное сравнение                      |
|*exp1* .<=> *exp2*          |       12  |       левая     |   int *collection*        |     поэлементный "космический корабль"          |
...
|ref *exp*                   |       17  |       правая    |    *T ref*                |     создание ссылки с начальным значением *exp* |
|*exp*'                      |       18  |       левая     |    как у *exp*            |     транспонирование массива                    |
|&#42;*exp*                  |       19  |       правая    |    deref type             |     разыменование ссылки                        |
|*exp1*.*name*               |       20  |       левая     |    тип члена              |     доступ к членам                             |
|*exp1*->*name*              |       20  |       левая     |    тип члена              |     разыменование и доступ                      |
|*exp1*.*number*             |       20  |       левая     |    тип члена              |     доступ к кортежу                            |
|*exp1*->*number*            |       20  |       левая     |    тип члена              |     разыменование и доступ                      |
