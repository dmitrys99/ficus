...
* целые числа и числа с плавающей точкой разной размерности:
  ...
  | `uint32` | Нет          | 32 бит     | 0..2<sup>32</sup>-1                       | `u32`   |
  | `int32`  | Да           | 32 бит     | -2<sup>31</sup>..2<sup>31</sup>-1         | `i32`   | Обратите внимание, `int32` и `int` друг в друга неявно не преобразуются.
  | `uint64` | Нет          | 64 бит     | 0..2<sup>64</sup>-1                       | `u64`   |
  | `int64`  | Да           | 64 бит     | -2<sup>63</sup>..2<sup>63</sup>-1         | `i64`   |
  | `half`   | Да           | 16 бит     | 2<sup>-14</sup>..65504                    | `h`     | В настоящий момент тип в Ficus не поддерживается, зарезервировано для будущих выпусков. 
  | `float`  | Да           | 32 бит     | -3.4e<sup>-38</sup>..3.4e<sup>+38</sup>   | `f`     |
  | `double` | Да           | 64 бит     | -1.7E<sup>-308</sup>..1.7E<sup>+308</sup> | &ndash; |
